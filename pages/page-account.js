...
function Account() {
    ...
    return (
        <>
            <Layout parent="Главная" sub="Аккаунт">
                                    ...
                                    <div className="col-md-3">
                                        <div className="dashboard-menu">
                                            <ul className="nav flex-column" role="tablist">
                                                ...
                                                <li className="nav-item">
                                                    <Link href="/page-login"><a className="nav-link"><i
                                                        className="fi-rs-sign-out mr-10"></i>Logout</a></Link>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div className="tab-content account dashboard-content pl-50">
                                                        ...
                                                        <div className="table-responsive">
                                                            <table className="table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="#"
                                                                           className="btn-small d-block">View</a></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>#2468</td>
                                                                    <td>June 29, 2020</td>
                                            ...
                                            <div
                                                ...
                                                <div className="card">
                                                    ...
                                                    <div className="card-body">
                                                        <p>Already have an account? <Link href="/page-login"><a>Log in
                                                            instead!</a></Link></p>
