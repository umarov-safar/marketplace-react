...
import {useGetCategory} from "../../src/api/catalog/categories";
import {useProducts} from "../../src/api/catalog/products";
import {DEFAULT_PERPAGE} from "../../util/constants";
...
const Category = ({productFilters}) => {
    ...
    const {data: categoryData, isSuccess, isLoading} = useGetCategory(router.query?.slug)

    let filter = {
        offset: 0,
        size: DEFAULT_PERPAGE,
        filter: {
            seller_id: seller?.id,
            categoryIds
        }
    ...
    return (
        <>
            <Layout noBreadcrumb="d-none">
                <CategoryBreadcrumb category={categoryData?.data}/>
                        ...
                        <div className="row flex-row-reverse">
                            <div className="col-lg-4-5">
                                ...
                                <div className="row product-grid">
                                    {isSuccess && products?.data.map((item, i) => (
                                        <div
                            ...
                            <div className="col-lg-1-5 primary-sidebar sticky-sidebar">
                                <div className="sidebar-widget widget-category-2 mb-30">
                                    ...
                                    <CategoryProduct subcategories={categoryData?.data?.children}/>
                                </div>
