        ...
        <>
            <div className="widget-area">
                ...
                <div className="sidebar-widget widget-category-2 mb-50">
                    ...
                    <ul>
                        <li>
                            <Link href="/products.js"><a> <img src="/assets/imgs/theme/icons/category-1.svg" alt=""/>Milks
                                & Dairies</a></Link><span className="count">30</span>
                        </li>
                        <li>
                            <Link href="/products.js"><a> <img src="/assets/imgs/theme/icons/category-2.svg" alt=""/>Clothing</a></Link><span
                            className="count">35</span>
                        </li>
                        <li>
                            <Link href="/products.js"><a> <img src="/assets/imgs/theme/icons/category-3.svg" alt=""/>Pet
                                Foods </a></Link><span className="count">42</span>
                        </li>
                        <li>
                            <Link href="/products.js"><a> <img src="/assets/imgs/theme/icons/category-4.svg" alt=""/>Baking
                                material</a></Link><span className="count">68</span>
                        </li>
                        <li>
                            <Link href="/products.js"><a> <img src="/assets/imgs/theme/icons/category-5.svg" alt=""/>Fresh
                                Fruit</a></Link><span className="count">87</span>
                        </li>
                    </ul>
                </div>
                ...
                <div className="sidebar-widget product-sidebar mb-50 p-30 bg-grey border-radius-10">
                    ...
                    <div className="single-post clearfix">
                        ...
                        <div className="content pt-10">
                            <h6><Link href="/products.js"><a>Chen Sweater</a></Link></h6>
                    ...
                    <div className="single-post clearfix">
                        ...
                        <div className="content pt-10">
                            <h6><Link href="/products.js"><a>Colorful Jacket</a></Link></h6>
                    ...
                    <div className="single-post clearfix">
                        ...
                        <div className="content pt-10">
                            <h6><Link href="/products.js"><a>Lorem, ipsum</a></Link></h6>
                            <p className="price mb-0 mt-5">$25</p>
                            <div className="product-rate">
                                <div className="product-rating" style={{"width": "60%"}}></div>
                            </div>
                ...
                <div className="sidebar-widget widget_instagram mb-50">
                    ...
                    <div className="instagram-gellay">
                        <ul className="insta-feed">
                            <li>
                                <Link href="#"><a><img className="border-radius-5"
                                                       src="/assets/imgs/shop/thumbnail-1.jpg" alt=""/></a></Link>
                            </li>
                            <li>
                                <Link href="#"><a><img className="border-radius-5"
                                                       src="/assets/imgs/shop/thumbnail-2.jpg" alt=""/></a></Link>
                            </li>
                            <li>
                                <Link href="#"><a><img className="border-radius-5"
                                                       src="/assets/imgs/shop/thumbnail-3.jpg" alt=""/></a></Link>
                            </li>
                            <li>
                                <Link href="#"><a><img className="border-radius-5"
                                                       src="/assets/imgs/shop/thumbnail-4.jpg" alt=""/></a></Link>
                            </li>
                            <li>
                                <Link href="#"><a><img className="border-radius-5"
                                                       src="/assets/imgs/shop/thumbnail-5.jpg" alt=""/></a></Link>
                            </li>
                            <li>
                                <Link href="#"><a><img className="border-radius-5"
                                                       src="/assets/imgs/shop/thumbnail-6.jpg" alt=""/></a></Link>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="sidebar-widget widget-tags mb-50 pb-10">
                    ...
                    <ul className="tags-list">
                        ...
                        <li className="hover-up mr-0">
                            <Link href="/blog-category-grid"><a><i
                                className="fi-rs-cross mr-10"></i>Appetizer</a></Link>
                        </li>
                    </ul>
                </div>
